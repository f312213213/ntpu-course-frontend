...
const NavItem = ({ navText, url }) => {
  return (
      <Link to={url}>
        <div className={'group p-4 flex items-center justify-center text-xl h-12 w-12 mt-2 mb-2 mx-auto bg-custom-700 shadow-lg hover:bg-custom-800 rounded-3xl cursor-pointer transition-all hover:rounded-xl'}>
          0
